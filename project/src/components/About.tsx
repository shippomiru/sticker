...
export function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About ClipPng - Free Transparent PNGs and Clipart Images</title>
        <meta 
          name="description" 
          content="Learn about ClipPng - a free resource for transparent PNGs and clipart images. Download and use our images for your creative projects." 
        />
        <link rel="canonical" href="https://clippng.online/about" />
      </Helmet>
